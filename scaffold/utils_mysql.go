...
func getPrimaryKey(obj map[string]map[string]string) string {
...
func generateMysqlTypes(obj map[string]map[string]string, depth int, jsonAnnotation bool, gormAnnotation bool, gureguTypes bool, isBlind bool) string {
	structure := "struct {"
